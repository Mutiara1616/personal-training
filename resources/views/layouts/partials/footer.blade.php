            ...
            <div class="mt-[52px]">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div class="space-y-1">
                            <a href="mailto:marketing-ptdi@indonesian-aerospace.com" class="block text-sm underline">marketing-ptdi@indonesian-aerospace.com</a>
                            <a href="mailto:sekretariatptdi@indonesian-aerospace.com" class="block text-sm underline">sekretariatptdi@indonesian-aerospace.com</a>
                            <a href="mailto:pub-rel@indonesian-aerospace.com" class="block text-sm underline">pub-rel@indonesian-aerospace.com</a>
                        </div>
                    </div>
